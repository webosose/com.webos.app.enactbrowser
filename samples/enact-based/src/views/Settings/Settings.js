...
const startupOptions = ["newTabPage", "continue", "homePage"],
    ...
    return (
      <Scroller {...rest} className={scrollerClass}>
        <div className={settingContentsClass}>
          ...
          <BodyText className={css.menu}>
            {$L("Always Show Bookmarks Bar")}
          </BodyText>
          <OnOffButton
            onClick={this.onToggleShowBookmarks}
            selected={alwaysShowBookmarks}
          />
          <br />

          <BodyText className={css.menu}>{$L("Private Browsing")}</BodyText>
          <OnOffButton
            onClick={this.onTogglePrivateBrowsing}
            selected={privateBrowsing}
          />
          <br />

          <BodyText className={css.menu}>{$L("Site Filtering")}</BodyText>
          <OnOffButton
            onClick={this.startSiteFiltering}
            selected={siteFiltering !== "off"}
          />
          <br />

          <Popup centered open={this.state.clearPopupOpen} noAutoDismiss>
            <span>{$L("Do you want to clear all browsing data?")}</span>
            <buttons>
              <Button onClick={this.onClearNo} size="small">
                {$L("NO")}
              </Button>
              <Button onClick={this.onClearYes} size="small">
                {$L("YES")}
              </Button>
            </buttons>
          </Popup>
          ...
          <Button onClick={this.onClearBrowsingData} css={css} size="small">
            {$L("CLEAR BROWSING DATA")}
          </Button>
          <br />
          ...
          >
            ...
            <buttons>
              <Button onClick={this.onResetNo} size="small">
                {$L("NO")}
              </Button>
              <Button onClick={this.onResetYes} size="small">
                {$L("YES")}
              </Button>
            </buttons>
          </Popup>
          ...
          >
            <span>
              {$L(this.state.resetState === "resetting"
                ? "Resetting settings..."
                : "All settings data has been restored.")}
            </span>
          </Popup>
          <br />
          <Button onClick={this.onResetDeaults} css={css} size="small">
            {$L("RESET SETTINGS")}
          </Button>
